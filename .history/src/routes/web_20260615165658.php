...
Route::group(['middleware' => ['auth:admin']], function () {
    ...
    Route::post('/admin/attendance/request/{id}', [AdminWorkingController::class, 'request'])->name('admin_request.update');
    ...
    Route::post('/export', [AdminWorkingController::class, 'export']);
...
Route::middleware('auth', 'verified')->group(function () {
    ...
    Route::get('/attendance/report', [WorkingController::class, 'export']);
...
Route::middleware('auth:web,admin')->group(function () {
    Route::match(['get', 'post'], '/stamp_correction_request/list', [ApplyController::class, 'mix_apply'])->name('apply.index');
});
