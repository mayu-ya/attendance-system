...
Route::group(['middleware' => ['auth:admin']], function () {
    ...
    Route::get('/admin/attendance/staff/{id}', [AdminWorkingController::class, 'person'])->name('person.index');

    Route::get('/stamp_correction_request/list', [AdminApplyController::class, 'wait'])->name('admin_wait.index');
    Route::get('/stamp_correction_request/list/apply', [AdminApplyController::class, 'approved'])->name('admin_approved.index');
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/attendance/list/sub', [WorkingController::class, 'subDay'])->name('sub.index');
    Route::get('/attendance/list/add', [WorkingController::class, 'addDay'])->name('add.index');
    ...
    Route::get('/stamp_correction_request/list', [ApplyController::class, 'apply'])->name('apply.index');
