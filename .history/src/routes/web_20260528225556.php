...
Route::group(['middleware' => ['auth:admin']], function () {
    ...
    Route::get('/stamp_correction_request/list', [AdminApplyController::class, 'apply'])->name('admin_apply.index');
    Route::get('/stamp_correction_request/list/apply', [AdminApplyController::class, 'show'])->name('admin_show.index');
