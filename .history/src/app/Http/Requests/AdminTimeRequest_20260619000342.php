...
class AdminTimeRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'rest.rest_start' => ['after:start_time', 'before:end_time'],
            'rest.rest_end' => ['before:end_time'],
            'content' => ['required'],
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'breaks.*.rest_end.before' => '休憩時間もしくは退勤時間が不適切な値です',
