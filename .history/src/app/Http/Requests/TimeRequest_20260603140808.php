...
class TimeRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'breaks[ $loop->index ][rest_start]' => ['after:start_time', 'before:end_time'],
            'rest_end' => ['before:end_time'],
            'content' => ['required'],
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'breaks[ $loop->index ][rest_start].after' => '休憩時間が不適切な値です',
            'breaks[ $loop->index ][rest_start].before' => '休憩時間が不適切な値です',
