...
class WorkingController extends Controller
{
    ...
    public function working__end(Request $request)
    {
        ...
        $totalBreakTime = BreakTime::where('attendance_record_id', '$workId')->sum('rest_total');

        AttendanceRecord::find($workId)->update([
    ...
    public function break__end(Request $request)
    {
        ...
        $now = Carbon::now();
        $breakStart = Corbon::parse($break->rest_start);
