...
class WorkingController extends Controller
{
    ...
    {
        if(Apply::where('attendance_record_id', $id);){
    ...
    {
        $item = $request->except('rest_start', 'rest_end');
        $breaks $request->input('rest_start', 'rest_end');

        $apply = Apply::create([
            'user_id' => Auth->user()->id,
            'attendance_record_id' => $id,
            'date' => Carbon::parse($item->date),
            'start_time' => Carbon::parse($item->date),
            'end_time' => Carbon::parse($item->date),
        ...
        foreach($breaks as $break){
            ...
            $restTotal = Carbon::parse($break->rest_total);
        ...
        return view('approval', compact('apply', 'rests'));
    }
