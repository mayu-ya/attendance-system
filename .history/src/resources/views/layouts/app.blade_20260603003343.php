    ...
    <header class="header">
        ...
        <div class="nav">
            <nav class="header-nav">
                ...
                <li class="header-nav__item">
                    <form action="{{ route('admin_apply.index') }}" class="form-nav" method="post">
                        @csrf
                ...
                <li class="header-nav__item">
                    <form action="{{ route('admin.logout') }}" class="form-nav" method="post">
                        @csrf
                ...
                <li class="header-nav__item">
                    <form action="{{ route('apply.index') }}" class="form-nav" method="post">
                        @csrf
                ...
                <li class="header-nav__item">
                    <form action="{{ route('web.logout') }}" class="form-nav" method="post">
                        @csrf
                        <button class="header-nav__button" type="submit">ログアウト</button>
                    </form>
                </li>
