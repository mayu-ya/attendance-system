    ...
    <div class="content-item">
        ...
        <div class="item">
            ...
            <div class="summary">
                <div class="summary-item">
                    ...
                    <div class="summary-time">{{ sprintf('%01dh%02dm', floor($count->total_work / 60), $count->total_work % 60) }}</div>
                </div>
                <div class="summary-item">
                    <p class="summary-p">総残業時間</p>
                    <div class="summary-time">時間</div>
                </div>
                <div class="summary-item">
        ...
        <div class="item">
            ...
            <table class="table">
                ...
                <tr class="table__inner">
                    <th class="table-item">月</th>
                    <th class="table-item">時間</th>
                    <th class="table-item">時間</th>
                </tr>
            </table>
        </div>
