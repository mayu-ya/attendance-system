                ...
                <tr class="table__inner">
                    ...
                    <td class="table-content">
                        <div class="input-date">
                            <input type="text" class="table-item__date" value="{{ \Carbon\Carbon::parse($apply['date'])->isoFormat('YYYY年') }}" readonly>
                            <input type="text" class="table-item__date" value="{{ \Carbon\Carbon::parse($apply['date'])->isoFormat('MM月DD日') }}" readonly>
                        </div>
                    </td>
                </tr>
                <tr class="table__inner">
