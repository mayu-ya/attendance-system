        ...
        <div class="item">
            ...
            @foreach($monthDays as $monthDay)
                <tr class="table__inner">
                    ...
                    <td class="table-td"><input type="text" class="table-input" value="{{ $monthDay['work']->start_time->format('H:i') ?? '' }}" readonly></td>
                    <td class="table-td"><input type="text" class="table-input" value="{{ $monthDay['work']->end_time ?? '' }}" readonly></td>
                    <td class="table-td">
                        <input type="text" class="table-input" value="{{ $monthDay['work']->duration ?? '' }}" readonly></td>
