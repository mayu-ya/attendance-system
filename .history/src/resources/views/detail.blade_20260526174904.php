    ...
    <div class="content-item">
        ...
        <form action="{{ route('detail.update', ['id'=>$work->id]) }}" class="form" method="post">
            ...
            <table class="table">
                ...
                <tr class="table__inner">
                    ...
                    <td class="table-content">
                        <div class="input-date">
                            <input type="text" name="year[date]" class="table-item__date" value="{{ \Carbon\Carbon::parse($work['date'])->isoFormat('YYYY年') }}" readonly>
                            <input type="text" name="day[date]" class="table-item__date" value="{{ \Carbon\Carbon::parse($work['date'])->isoFormat('MM月DD日') }}" readonly>
                        </div>
                    </td>
                </tr>
                <tr class="table__inner">
                ...
                <tr class="table__inner">
                    ...
                    <td class="table-content">
                        <input type="text" name="breaks[rest_start]" class="table-item" value="{{ substr($break->rest_start, 0, 5) ?? '' }}"><span class="table-span">～</span>
                        <input type="text" name="breaks[rest_end]" class="table-item" value="{{ substr($break->rest_end, 0, 5) ?? '' }}">
                   </td>
                </tr>
                @endforeach
                <tr class="table__inner">
        ...
        <div class="form">
            <table class="table">
                <tr class="table__inner">
                    <th class="table-title">名前</th>
                    <td class="table-content"><input type="text" class="table-item__name" value="{{ $apply->user->name }}" readonly></td>
                </tr>
                <tr class="table__inner">
                    <th class="table-title">日付</th>
                    <td class="table-content">
                ...
                <tr class="table__inner">
                    <th class="table-title">出勤・退勤</th>
                    <td class="table-content">
                        <input type="text" name="start_time" class="table-item" value="{{ substr($apply->start_time, 0, 5) ?? '' }}" readonly><span class="table-span">～</span>
                        <input type="text" name="end_time" class="table-item" value="{{ substr($apply->end_time, 0, 5) ?? '' }}" readonly>
                    </td>
                </tr>
                ...
                <tr class="table__inner">
                    ...
                    <td class="table-content">
                        <input type="text" name="rest_start" class="table-item" value="{{ substr($rest->rest_start, 0, 5) ?? '' }}" readonly><span class="table-span">～</span>
                        <input type="text" name="rest_end" class="table-item" value="{{ substr($rest->rest_end, 0, 5) ?? '' }}" readonly>
                   </td>
                </tr>
                @endforeach
                <tr class="table__inner">
