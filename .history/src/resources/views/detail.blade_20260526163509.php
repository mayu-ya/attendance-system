                ...
                <tr class="table__inner">
                    ...
                    <td class="table-content">
                        <div class="input-date">
                            <input type="text" name="date" class="table-item__date" value="{{ \Carbon\Carbon::parse($work['date'])->isoFormat('YYYY年') }}" readonly>
                            <input type="text" name="date" class="table-item__date" value="{{ \Carbon\Carbon::parse($work['date'])->isoFormat('MM月DD日') }}" readonly>
                        </div>
                    </td>
                </tr>
                <tr class="table__inner">
