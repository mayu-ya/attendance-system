        ...
        <form action="" class="form">
            ...
            <table class="table">
                ...
                <tr class="table__inner">
                    ...
                    <td class="table-content">
                        <input type="text" name="rest_start" class="table-item" value="{{ \Carbon\Carbon::parse($work['rest_start'])->format('H:i') }}"><span class="table-span">～</span>
                        <input type="text" name="rest_end" class="table-item" value="{{ \Carbon\Carbon::parse($work['rest_end'])->format('H:i') }}">
                   </td>
                </tr>
                <tr class="table__inner">
