        ...
        <form action="" class="form">
            ...
            <table class="table">
                ...
                <tr class="table__inner">
                    ...
                    <td class="table-content">
                        <input type="text" name="" class="table-item" readonly><span class="table-span">～</span>
                        <input type="text" name="" class="table-item" readonly>
                   </td>
                </tr>
                @endforeach
                <tr class="table__inner">
                    ...
                    <td class="table-content">
                        <input type="text" name="rest_start" class="table-item" readonly><span class="table-span">～</span>
                        <input type="text" name="rest_end" class="table-item" readonly>
                    </td>
                </tr>
                <tr class="table__inner">
