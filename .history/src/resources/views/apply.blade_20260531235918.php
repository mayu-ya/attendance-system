    ...
    <div class="content-item">
        ...
        <div class="content__group">
            <form action="{{ route('apply.index') }}" class="form">
                @csrf
                <input type="hidden" name="action" value="wait" method="get">
                <button class="button">承認待ち</button>
            </form>
            <form action="" class="form">
                @csrf
                <input type="hidden" name="action" value="apply" method="get">
                <button class="button">承認済み</button>
            </form>
            <div class="content-title__wait"><a href="{{ route('apply.index') }}" class="title__wait">承認待ち</a></div>
