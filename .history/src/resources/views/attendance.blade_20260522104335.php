        ...
        <div class="item">
            ...
            @foreach($monthDays as $monthDay)
                <tr class="table__inner">
                    ...
                    <td class="table-td">@if($monthDay[work]->end_time)<input type="text" class="table-input" value="{{ substr($monthDay['work']?->end_time, 0, 5) ?? '' }}" readonly>@endif</td>
                    <td class="table-td">
                        <input type="text" class="table-input" value="{{ substr($monthDay['work']?->duration, 0, 5) ?? '' }}" readonly></td>
