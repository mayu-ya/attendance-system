        ...
        <div class="item">
            ...
            @foreach($monthDays as $monthDay)
                <tr class="table__inner">
                    ...
                    <td class="table-td">
                        <input type="text" class="table-input" value="{{ $monthDay['work']->duration ? sprintf('%02d:%02d:00', floor($monthDay['work']->duration / 60), $monthDay['work']->duration % 60) : '00:00' ?? '' }}" readonly></td>
