            ...
            <table class="table">
                ...
                <tr class="table__inner">
                    ...
                    <td class="table-content">
                        ...
                        <input type="text" name="breaks[{{ $loop->index }}][rest_start]" class="table-item" value="{{ substr($break->rest_start, 0, 5) ?? '' }}" readonly><span class="table-span">～</span>
                        <input type="text" name="breaks[{{ $loop->index }}][rest_end]" class="table-item" value="{{ substr($break->rest_end, 0, 5) ?? '' }}" readonly>
                   </td>
                </tr>
                @endforeach
                @elseif($work)
                ...
                <tr class="table__inner">
                    ...
                    <td class="table-content">
                        <input type="text" name="rest_start" class="table-item-list" value="{{ substr($break->rest_start, 0, 5) ?? '' }}"><span class="table-span">～</span>
                        <input type="text" name="rest_end" class="table-item-list" value="{{ substr($break->rest_end, 0, 5) ?? '' }}">
                    </td>
                </tr>
                @endforeach
                <tr class="table__inner">
