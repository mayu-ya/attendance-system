    ...
    <div class="content-item">
        ...
        <div class="item">
            <table class="table">
                ...
                <tr class="table__inner">
                    <td class="table-td"><input type="text" name="" class="table-input" value="{{ $user->name }}" readonly></td>
                    <td class="table-td"><input type="text" name="" class="table-input__email" value="{{ $user->email }}" readonly></td>
                    <td class="table-td">
                        <div class="link">
