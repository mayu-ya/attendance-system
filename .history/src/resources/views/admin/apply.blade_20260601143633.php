...
@section('css')
<link rel="stylesheet" href="{{ asset('css/admin/apply.css') }}">
@endsection
...
<div class="content">
    <div class="content-item">
        ...
        <div class="content__group">
            <form action="{{ route('admin_apply.index') }}" class="form" method="post">
                @csrf
                <input type="hidden" name="action" value="wait">
                <button class="button__wait">承認待ち</button>
            </form>
            <form action="" class="form" method="post">
                @csrf
                <input type="hidden" name="action" value="apply">
                <button class="button__apply">承認済み</button>
            </form>
        </div>
        ...
        <div class="item">
            <table class="table">
                ...
                <tr class="table__inner">
                    ...
                    <td class="table-td"><input type="text" class="table-input-content" value="{{ $apply->content }}" readonly></td>
                    <td class="table-td"><input type="text" class="table-input" value="{{ $apply->update_at_formatted }}" readonly></td>
                    <td class="table-td">
                        <div class="button">
                            <a href="{{ route('request.index', ['attendance_correct_request_id' => $apply->id]) }}" class="link-a">詳細</a>
                        </div>
                    </td>
                </tr>
                @endforeach
