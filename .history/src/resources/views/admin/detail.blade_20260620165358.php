            ...
            <table class="table">
                <tr class="table__inner">
                    ...
                    <td class="table-content">
                        <input type="text" name="name" class="table-item__name" value="{{ $work->user->name }}" readonly">
                    </td>
                </tr>
                <tr class="table__inner">
                ...
                <tr class="table__inner">
                    ...
                    <td class="table-content">
                        <input type="text" name="breaks[{{ $loop->index }}][rest_start]" class="table-item-list" value="{{ substr($rest->rest_start, 0, 5) ?? '' }}" readonly><span class="table-span">～</span>
                        <input type="text" name="breaks[{{ $loop->index }}][rest_end]" class="table-item-list" value="{{ substr($rest->rest_end, 0, 5) ?? '' }}" readonly>
                    </td>
                </tr>
                @endforeach
                @elseif($work->breaks)
