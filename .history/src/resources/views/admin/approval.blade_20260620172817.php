        ...
        <form action="{{ route('approval.update') }}" class="form" method="post">
            ...
            <table class="table">
                ...
                <tr class="table__inner">
                    ...
                    <td class="table-content">
                        <input type="text" class="table-item__date" value="{{ $apply->date_year }}" readonly>
                        <input type="text" class="table-item__date" value="{{ $apply->date_day }}" readonly>
                    </td>
                </tr>
                <tr class="table__inner">
                    <th class="table-title">出勤・退勤</th>
                    <td class="table-content">
                        <input type="text" class="table-item" value="{{ $apply->start_time }}" readonly><span class="table-span">～</span>
                        <input type="text" class="table-item" value="{{ $apply->end_time }}" readonly>
                    </td>
                </tr>
                ...
                <tr class="table__inner">
                    ...
                    <td class="table-content">
                        ...
                        <input type="text" name="breaks[{{ $loop->index }}][rest_end]" class="table-item" value="{{ $rest->rest_end }}" readonly>
                   </td>
                </tr>
                @endforeach
                <tr class="table__inner">
