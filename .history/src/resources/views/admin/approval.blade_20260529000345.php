        ...
        <form action="" class="form">
            ...
            <table class="table">
                <tr class="table__inner">
                    ...
                    <td class="table-content"><input type="text" name="" class="table-item__name" value="{{ $apply->user->name }}" readonly></td>
                </tr>
                <tr class="table__inner">
                    <th class="table-title">日付</th>
                    <td class="table-content"><input type="text" name="" class="table-item__date" value="" readonly></td>
                </tr>
                <tr class="table__inner">
