...
class ReportTest extends TestCase
{
    ...
    public function test_report()
    {
        ...
        $totalOverTime = sprintf('%01dh%01dm', floor($count->total_overtime / 60), $count->total_overtime % 60);
        $averageWork = sprintf('%01dh%01dm', floor($count->average_work / 60), $count->average_work % 60);
