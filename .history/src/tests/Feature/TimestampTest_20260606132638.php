...
class TimestampTest extends TestCase
{
    ...
    public function test_many_time_breaks()
    {
        ...
        $response = get('/attendance')->assertSee('休憩入');
    }
    ...
    public function test_break_button()
    {
        ...
        $response = get('/attendance')->assertSee('出勤中');
    }
    ...
    public function test_many_time_end_breaks()
    {
        ...
        $response = get('/attendance')->assertSee('休憩戻');
    }
    ...
    public function test_time_list()
    {
        ...
        $response = get('/attendance/list')->assertSee('休憩戻');
    }
