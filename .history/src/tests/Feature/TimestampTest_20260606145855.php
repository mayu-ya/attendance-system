...
class TimestampTest extends TestCase
{
    ...
    public function test_time_list()
    {
        ...
        $response = $this->get('/attendance/detail-{id}', ['id'=>$attendance->id])->assertSee($break->rest_start);
        $response = $this->get('/attendance/detail-{id}', ['id'=>$attendance->id])->assertSee($break->rest_end);
    }
